...
ifndef::env-devbox[]
The shell is installed with the devbox. Please read the section <<_Install_outside_the_devbox>> if you need to install it on a different system.
...
Some examples of CMD are:

- #puppet4.agent# to migrate a node to puppet 4.
- #verify.host# to verify machine specifications.
