...
.Help output after invoking #cicd#
....
→ cicd
...
cicd help (html | topic)
```

The auto-completion feature helps you to complete the command. You can also request the help at each level. For instance:
```
